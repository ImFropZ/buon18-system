...
export const QuoteItemSchema = z.object({
    ...
    quantity: numberInString.pipe(z.number().min(1, {
        message: "Quantity must be at least 1.",
    })),
    unit_price: numberInString.pipe(z.number().min(0, {
...
export const QuoteCreateSchema = z.object({
    ...
    discount: numberInString.pipe(z.number().min(0, {
...
export const QuoteSchema = z.intersection(QuoteCreateSchema, z.object({
    id: z.string().or(z.number()),
